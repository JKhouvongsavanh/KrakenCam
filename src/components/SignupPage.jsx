    ...
    return (
      <div className="auth-page">
        <div className="auth-card auth-card--wide">
          ...
          {refCode && (
            <div style={{ display:'inline-flex', alignItems:'center', gap:6, padding:'5px 14px', borderRadius:20, background:'rgba(61,186,126,.12)', border:'1px solid rgba(61,186,126,.3)', color:'#3dba7e', fontSize:12, fontWeight:600, marginBottom:8 }}>
